...
const sidebars = {
  ...
  unreal: [
    ...
    { label: "脚本调用UClass（U++、蓝图）", type: 'doc', id: 'puerts/unreal/script_call_uclass' },
    { label: "脚本调用普通C++", type: 'doc', id: 'puerts/unreal/template_binding' },
    { label: "C++（U++）、蓝图调用脚本", type: 'doc', id: 'puerts/unreal/engine_call_script' },
